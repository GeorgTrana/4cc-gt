# THIS IS A FORK OF MY OWN!!!

Personal 4coder repo based on 4cc 4.1.8 and some modifications to the fleury layer. This is only made to work for my own computer (Ubuntu and Debian distributions), beware.
